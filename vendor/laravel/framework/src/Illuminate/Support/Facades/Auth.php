...
use Illuminate\Support\Testing\Fakes\Auth as AuthFake;
 ...
 * @method static \Illuminate\Auth\AuthManager setApplication(Application $app)
 ...
 * @method static Guard setUser(\Illuminate\Contracts\Auth\Authenticatable $user)
 ...
 * @method static AuthFake fake(array $users = [])
 *
...
class Auth extends Facade
{
    ...
    {
        throw new RuntimeException('Authentication routes are no longer automatically defined. Please define them manually.');
    }
}
