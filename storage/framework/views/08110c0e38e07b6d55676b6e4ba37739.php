...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <?php $__errorArgs = ['kwh_meter_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="text-center text-gray-500 text-xs mt-4">
            © <?php echo e(date('Y')); ?> My Company. All rights reserved.
        </p>
        <div class="mt-4 text-center">
            <span class="text-gray-600 text-sm">Already have an account?</span>
            <a href="<?php echo e(route('login')); ?>" class="text-blue-500 hover:text-blue-700 font-bold text-sm">Login</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>