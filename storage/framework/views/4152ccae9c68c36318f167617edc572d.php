                ...
                <div class="card-body">
                    ...
                    <?php if($user): ?> 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo e($user->kwh_meter_code ?? 'Not Set'); ?>" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="mt-4">
                            <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-primary shadow-sm">
                    ...
                    <?php else: ?>
                        <div class="alert alert-warning" role="alert">
                            User not authenticated. Please <a href="<?php echo e(route('login')); ?>" class="alert-link">log in</a>.
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\resources\views/pages/profile/show.blade.php ENDPATH**/ ?>